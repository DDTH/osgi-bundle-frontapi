...
public class TApiResult implements org.apache.thrift.TBase<TApiResult, TApiResult._Fields>, java.io.Serializable, Cloneable, Comparable<TApiResult> {
  ...
  private static final org.apache.thrift.protocol.TField JSON_OUTPUT_FIELD_DESC = new org.apache.thrift.protocol.TField("jsonOutput", org.apache.thrift.protocol.TType.STRING, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new TApiResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TApiResultTupleSchemeFactory());
  }

  public int status; // required
  public String jsonOutput; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    STATUS((short)1, "status"),
    JSON_OUTPUT((short)2, "jsonOutput");
  ...
  public TApiResult setJsonOutput(String jsonOutput) {
    this.jsonOutput = jsonOutput;
    return this;
  }
  ...
  public boolean equals(TApiResult that) {
    ...
    boolean this_present_jsonOutput = true && this.isSetJsonOutput();
    boolean that_present_jsonOutput = true && that.isSetJsonOutput();
    if (this_present_jsonOutput || that_present_jsonOutput) {
      if (!(this_present_jsonOutput && that_present_jsonOutput))
        return false;
      if (!this.jsonOutput.equals(that.jsonOutput))
        return false;
    }
  ...
  public int compareTo(TApiResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetJsonOutput()).compareTo(other.isSetJsonOutput());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJsonOutput()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TApiResult(");
    boolean first = true;
  ...
  private static class TApiResultStandardSchemeFactory implements SchemeFactory {
    public TApiResultStandardScheme getScheme() {
      return new TApiResultStandardScheme();
    }
  }

  private static class TApiResultStandardScheme extends StandardScheme<TApiResult> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // JSON_OUTPUT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.jsonOutput = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TApiResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.jsonOutput != null) {
        oprot.writeFieldBegin(JSON_OUTPUT_FIELD_DESC);
        oprot.writeString(struct.jsonOutput);
        oprot.writeFieldEnd();
      }
  ...
  private static class TApiResultTupleSchemeFactory implements SchemeFactory {
    public TApiResultTupleScheme getScheme() {
      return new TApiResultTupleScheme();
    }
  }

  private static class TApiResultTupleScheme extends TupleScheme<TApiResult> {
